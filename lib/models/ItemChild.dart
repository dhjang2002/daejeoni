...
class ItemChild {
  ...
  String getProfile() {
    ...
    String profile = "$age세 ( $parntsChldrnBrdt )";
    return profile;
  }
  ...
  static List<ItemChild> fromSnapshot(List snapshot) {
    return snapshot.map((data) {
      return ItemChild.fromJson(data);
    }).toList();
  }

  factory ItemChild.fromJson(Map<String, dynamic> jdata){
    // if (kDebugMode) {
    //   var logger = Logger();
    //   logger.d(jdata);
    // }
